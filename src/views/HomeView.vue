        ...
        <div class="wrapper absolute w-full h-full flex">
            <div class="flex flex-col justify-center sm:px-24 sm:w-1/2 px-6">
                ...
                >
                    ...
                    <div class="animate-rise opacity-0 animation-delay-75">
                        Enthusiastic
                    </div>
                    <div class="animate-rise opacity-0 animation-delay-150">
                        Developer.
                    </div>
                </div>
                <div
            ...
            >
                ...
                >
                    ...
                    <div
                        class="github flex gap-y-2 flex-col items-center justify-center animate-rise animation-delay-220 opacity-0"
                    >
                        <div class="number text-4xl">{{ stars }}</div>
                        <div class="title text-xl">Stars</div>
                    </div>
                    <div
                        class="github flex gap-y-2 flex-col items-center justify-center animate-rise animation-delay-240 opacity-0"
                    >
...
(async () => {
    // Get the followers
    followers.value = (
        await (await fetch("https://api.github.com/users/kyeboard")).json()
    ).followers;

    // Get the total number of stars
    let _stars = 0;
    const repos = await (
        await fetch("https://api.github.com/users/kyeboard/repos")
    ).json();
