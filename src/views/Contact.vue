<template>
    ...
    >
        <div class="font-extrabold text-4xl animate-rise opacity-0">
            Contact Me
        </div>
        ...
        <div
            class="h-2/3 w-2/3 mt-7 rounded-2xl bg-text/40 p-4 flex animate-rise opacity-0 animation-delay-200"
        >
            <div
                class="w-1/3 relative bg-text/60 rounded-2xl overflow-hidden text-left p-10 flex flex-col"
            >
                <div
                    class="font-bold text-2xl animate-rise opacity-0 animation-delay-220"
                >
                    Contact Information
                </div>
                <div
                    class="font-semibold mt-4 text-gray-700 animate-rise opacity-0 animation-delay-240"
                >
                    Fill up the form and I will be back as soon as possible!
                </div>
                <div
                    class="mt-6 text-gray-700 flex items-center font-semibold animate-rise opacity-0 animation-delay-260"
                >
                ...
                <div class="socials mt-auto text-gray-700 gap-x-7 flex">
                    <a
                        href="https://github.com/kyeboard"
                    ...
                    <a
                        ...
                        class="animate-rise opacity-0 animation-delay-280"
                        ><vue-feather type="twitch" size="20"></vue-feather
                    ></a>
                    <a
                        href="https://twitter.com/kyeboard_"
                        class="animate-rise opacity-0 animation-delay-300"
                        ><vue-feather type="twitter" size="20"></vue-feather
                    ></a>
                    <a
                        href="https://youtube.com/@kyeboard"
                        class="animate-rise opacity-0 animation-delay-320"
            ...
            <div class="w-2/3 ml-6 mt-6 flex flex-col">
                <div class="flex items-start justify-start font-semibold">
                    <div
                        class="wrapper w-full animate-rise opacity-0 animation-delay-200"
                    >
                    ...
                    <div
                        class="wrapper w-full ml-6 animate-rise opacity-0 animation-delay-220"
                    >
                        <div class="text-start mb-1">First name</div>
                        <input
                ...
                <div class="flex mt-6 items-start justify-start font-semibold">
                    <div
                        class="wrapper w-full animate-rise opacity-0 animation-delay-240"
                    >
                    ...
                    <div
                        class="wrapper w-full ml-6 animate-rise opacity-0 animation-delay-260"
                    >
