...
<div class="h-full fixed top-0 flex-col gap-y-8 left-0 w-20 border-r-2 text-surface1 flex items-center justify-center border-r-surface0/40">
    ...
    <a href="https://twitter.com/tokayakii_"><vue-feather type="twitter" size="21"></vue-feather></a>
    <a href="https://www.twitch.tv/tokayakii_"><vue-feather type="twitch" size="21"></vue-feather></a>
    <a href="https://github.com/tokayakii"><vue-feather type="youtube" size="21"></vue-feather></a>
</div>
</template>
