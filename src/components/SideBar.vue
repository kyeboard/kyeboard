<template>
    <div
        class="h-full side-bar hidden bg-base sm:flex fixed z-40 top-0 flex-col gap-y-8 left-0 w-20 border-r text-surface1 items-center justify-center border-r-surface0/40"
    >
